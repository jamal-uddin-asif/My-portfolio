          ...
          <div className="order-2 lg:order-1 text-left">
            ...
            >
              ...
              <p className="max-w-xl text-slate-600 dark:text-slate-400 text-lg sm:text-xl leading-relaxed mb-10">
                ...
                , crafting high-performance digital experiences in Bangladesh. I
                turn complex problems into elegant, user-centric solutions.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  href="/Jamal_Uddin_Asif_Deb_Resume.pdf"
