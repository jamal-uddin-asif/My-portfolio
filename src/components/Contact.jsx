...
export default function Contact() {
  ...
  const socials = [
    ...
    {
      icon: <FaLinkedin />,
      link: "https://www.linkedin.com/in/asif-jamaluddin/",
    },
    {
      icon: <FaFacebook />,
  ...
  const contacts = [
    {
      icon: <FaEnvelope />,
      label: "Email",
      value: "jamaluddin.dev@gmail.com",
      link: "mailto:jamaluddin.dev@gmail.com",
    },
    {
      icon: <FaPhone />,
      label: "Phone",
      value: "01610990018",
      link: "tel:01610990018",
    },
    {
      icon: <FaWhatsapp />,
      label: "WhatsApp",
      value: "+880 1610 990018",
      link: "https://wa.me/8801610990018",
    },
  ];
  ...
  return (
    <section
      id="contact"
      className="py-24 px-3 bg-white dark:bg-[#0a0a0a] overflow-hidden"
    >
      <Container>
          ...
          >
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 text-lg max-w-md">
                I am available for full-time opportunities. Reach out and let's
                chat!
              </p>
            </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-5 py-4 focus:ring-2 focus:ring-primary outline-none transition-all dark:text-white"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  placeholder="Message"
                  className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-5 py-4 focus:ring-2 focus:ring-primary outline-none transition-all dark:text-white resize-none"
                ></textarea>
              </div>
